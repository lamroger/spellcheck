...
==========
 ...
 - My personal goal was to test the limitations of Bash.
...
/usr/share/dict/words in the file words_short
...
of the algorithm. May take additional runtime. 
 - Could create an associative array to keep track of permutations to see if we already checked that word
